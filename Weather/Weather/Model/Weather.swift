...
struct WeatherReport: Identifiable {
    ...
    static func empty() -> WeatherReport {
        return WeatherReport(id: "", city: City(name: ""), main: "", description: "", temperatureReport: TemperatureReport(id: "", current: Temperature.empty(), dailyHigh: Temperature.empty(), dailyLow: Temperature.empty(), feelsLike: Temperature.empty()))
    }
